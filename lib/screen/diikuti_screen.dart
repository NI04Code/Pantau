...
class DiikutiScreen extends ConsumerStatefulWidget{
  @override
  ConsumerState<ConsumerStatefulWidget> createState() {
    // TODO: implement createState
    return _DiikutiScreenState();
  }
}
class _DiikutiScreenState extends ConsumerState<DiikutiScreen>{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: StreamBuilder(
          stream: FirebaseFirestore.instance.collection('posts').where('diikuti', arrayContains: user.uid).snapshots(),
